export const analyzeTradesForCompletion = (
  ...
  trades.forEach((trade) => {
    ...
    const longTradePriceData = {
      c: sData.c.slice(timeIndex - 72, currIndex + 1),
      o: sData.o.slice(timeIndex - 72, currIndex + 1),
      h: sData.h.slice(timeIndex - 72, currIndex + 1),
      l: sData.l.slice(timeIndex - 72, currIndex + 1),
      t: sData.t.slice(timeIndex - 72, currIndex + 1),
      v: sData.v.slice(timeIndex - 72, currIndex + 1),
    };
